package com.beat.mall.user.module.aspect;

import com.beat.mall.user.module.datasource.DataSourceContextHolder;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.beat.mall.user.module.annotation.ReadOnly)")
