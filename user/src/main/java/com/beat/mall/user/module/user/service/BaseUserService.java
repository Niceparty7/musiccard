package com.beat.mall.user.module.user.service;

import com.beat.mall.user.module.annotation.ReadOnly;
import com.beat.mall.common.entity.user.User;
import com.beat.mall.user.module.user.mapper.UserMapper;
...
import static com.beat.mall.user.module.user.service.UserDefine.GENDER_MALE;
