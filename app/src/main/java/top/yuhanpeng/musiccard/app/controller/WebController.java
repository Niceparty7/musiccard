...
public class WebController {
    ...
    String bucket = "musiccard-resources";
    String region = "cn-wuhan-lr";
    String host = "http://musiccard-resources.oss-cn-wuhan-lr.aliyuncs.com";
    // 设置上传回调URL（即回调服务器地址），必须为公网地址。用于处理应用服务器与OSS之间的通信，OSS会在文件上传完成后，把文件上传信息通过此回调URL发送给应用服务器。
    String callbackUrl = "http://oss-demo.aliyuncs.com:23450/callback"; // 设置回调请求的服务器地址，例如http://oss-demo.aliyuncs.com:23450/callback。
    //限定上传到OSS的文件前缀。
    ...
    public static com.aliyun.sts20150401.Client createStsClient() throws Exception {
        ...
        config.endpoint = "sts.cn-wuhan-lr.aliyuncs.com";
