package com.beat.mall.music.console.controller.sms;
...
import com.beat.mall.music.console.feign.SmsFeign;
...
@RequestMapping(value = "/sms", headers = "X-Client-Type=console")
